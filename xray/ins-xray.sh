...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/paie/acc/xay/main/nginx.conf"
mkdir -p /home/vps/public_html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/paie/acc/xay/main/vps.conf"
...
# install xray
wget -q -O /usr/local/bin/xray "https://raw.githubusercontent.com/paie/acc/xray/xray"
